...
public enum DependencyMode {
  Typed, AllTyped, TypedCollapsed, TypedCCprocessed, Enhanced, EnhancedPlusPlus;
  protected static Collection<TypedDependency> getDependencies(
    ...
    } else if(mode.equals(Enhanced)) {
      result = gs.typedDependenciesEnhanced();
    } else if(mode.equals(EnhancedPlusPlus)) {
      result = gs.typedDependenciesEnhancedPlusPlus();
    }
